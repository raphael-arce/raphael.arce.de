...
<figure>
	<video controls className="mx-auto">
		<source src="/zoom-in.webm" type="video/webm" />
	</video>
...
<figure>
	<video controls className="mx-auto">
		<source src="/zoom-out.webm" type="video/webm" />
	</video>
...
And that's it! If we plug those values back into the algorithm
...
In Part 3 (coming soon), we will look at how panning works.
